...
const CitySelect = ({ formik }) => {
  ...
  useEffect(() => {
    const fetchCities = async () => {
      if (!formik.values.country_uid) return;
      ...
      try {
        ...
        const response = await axios.get(`${import.meta.env.VITE_APP_API_URL}/cities/list?filter[country_uid]=${formik.values.country_uid}`, {
          headers: {
    ...
    fetchCities();
  }, [formik.values.country_uid]); // 🔥 Re-fetch when country changes
