    ...
    try {
      ...
      const filteredBranches = branchesData.filter((branch) => {
        ...
        if (
          ...
          branch.city?.name?.toString().toLowerCase() !==
        ...
        if (
          ...
          branch.zone?.name?.toString().toLowerCase() !==
            formik.values.zone_name.toLowerCase()
        ) {
          return false;
        }
      ...
      <div className="card-body p-0 overflow-x-auto relative">
        <div className="card-header px-2 flex-wrap gap-2 justify-between">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto">
            ...
            <select
              className="select select-sm select-bordered w-24 h-9 "
              value={status}
              onChange={(e) => {
            ...
            <button
              ...
              onClick={() => navigate(`/network/add-branch`)}
            >
              Add New Branch
            </button>
          </div>
