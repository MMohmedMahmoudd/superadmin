...
return (
  ...
  <div className="card mt-5 p-4">
    ...
    <div className="col-span-1">
        ...
        <input className="input"   value={formik.values.name} onChange={(e) => formik.setFieldValue('name', e.target.value)}/>
    ...
    <p className="text-red-500 text-xs mt-1">{formik.errors.name}</p>
      ...
      <label className="form-label ">Branch Name in Arabic</label>
        <input className="input"   value={formik.values.name_both_lang} onChange={(e) => formik.setFieldValue('name_both_lang', e.target.value)}/>
        {formik.touched.name_both_lang && formik.errors.name_both_lang && (
    <p className="text-red-500 text-xs mt-1">{formik.errors.name_both_lang}</p>
  )}
      </div>
      <div>
  ...
  {formik.touched.status && formik.errors.status && (
    ...
    <p className="text-red-500 text-xs mt-1">{formik.errors.zone_uid}</p>
      ...
      <div className="col-span-2">
        ...
        <input className="input" value={formik.values.address} onChange={(e) => formik.setFieldValue('address', e.target.value)} />
    ...
    <p className="text-red-500 text-xs mt-1">{formik.errors.address}</p>
      ...
      <div className="col-span-2">
        ...
        <input className="input" value={formik.values.address_ar} onChange={(e) => formik.setFieldValue('address_ar', e.target.value)} />
      ...
      <div className="flex items-center justify-between gap-2 mt-4 col-span-2 px-4 dark:bg-gray-100 border border-gray-300 p-4 rounded-md">
        ...
        <label className="flex switch items-center gap-2 cursor-pointer">
          <input
            ...
            onChange={(e) => {
              formik.setFieldValue('main_branch', e.target.checked ? 1 : 0);
            }}
          />
          {formik.touched.main_branch && formik.errors.main_branch && (
    <p className="text-red-500 text-xs mt-1">{formik.errors.main_branch}</p>
  )}
        </label>
      ...
      <div>
        ...
        <input className="input" value={formik.values.latitude} onChange={(e) => formik.setFieldValue('latitude', e.target.value)} />
    ...
    <p className="text-red-500 text-xs mt-1">{formik.errors.latitude}</p>
      ...
      <div>
        ...
        <input className="input" value={formik.values.longitude} onChange={(e) => formik.setFieldValue('longitude', e.target.value)} />
