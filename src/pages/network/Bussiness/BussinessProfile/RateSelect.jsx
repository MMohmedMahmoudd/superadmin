...
const options = [
  {
    value: "",
    icon: <span className="text-sm whitespace-nowrap">All Ratings</span>,
  },
  {
    value: "5",
    icon: (
      <>
        <Rating value={1} size="small" max={1} className="text-yellow-400" />
        <span className="text-sm w-5">5</span>
      </>
    ),
  },
  {
    ...
    icon: (
      <>
        <Rating value={1} size="small" max={1} className="text-yellow-400" />
        <span className="text-sm w-5">4.5</span>
      </>
    ),
  },
  {
    ...
    icon: (
      <>
        <Rating value={1} size="small" max={1} className="text-yellow-400" />
        <span className="text-sm w-5">4</span>
      </>
    ),
  },
  {
    ...
    icon: (
      <>
        <Rating value={1} size="small" max={1} className="text-yellow-400" />
        <span className="text-sm w-5">3.5</span>
      </>
    ),
  },
  {
    ...
    icon: (
      <>
        <Rating value={1} size="small" max={1} className="text-yellow-400" />
        <span className="text-sm w-5">3</span>
      </>
    ),
  },
  {
    ...
    icon: (
      <>
        <Rating value={1} size="small" max={1} className="text-yellow-400" />
        <span className="text-sm w-5">2.5</span>
      </>
    ),
  },
  {
    ...
    icon: (
      <>
        <Rating value={1} size="small" max={1} className="text-yellow-400" />
        <span className="text-sm w-5">2</span>
      </>
    ),
  },
  {
    ...
    icon: (
      <>
        <Rating value={1} size="small" max={1} className="text-yellow-400" />
        <span className="text-sm w-5">1.5</span>
      </>
    ),
  },
  {
    ...
    icon: (
      <>
        <Rating value={1} size="small" max={1} className="text-yellow-400" />
        <span className="text-sm w-5">1</span>
      </>
    ),
  },
];
