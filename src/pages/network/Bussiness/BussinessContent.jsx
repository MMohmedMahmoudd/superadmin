        ...
        return (
          <div className="flex items-center gap-3">
            <img src={image || toAbsoluteUrl('/media/avatars/blank.png')}
             className="w-9 h-9 rounded-full object-cover" alt={name}
             onError={(e) => {
            ...
            />
            <div>
              <div className="text-sm font-semibold hover:text-primary cursor-pointer " onClick={() => handleRowClick (row.original.id)}
              >{name}</div>
