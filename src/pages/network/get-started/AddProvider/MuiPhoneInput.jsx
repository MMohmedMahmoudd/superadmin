...
const MuiPhoneInput = ({ value, onChange, defaultCountry, forceCallingCode }) => {
  return (
    <StyledMuiTelInput
      defaultCountry={defaultCountry || "EG"} // ✅ Default to Egypt
      value={value}
      typeof="tel"
      onChange={onChange}
      preferredCountries={["SA", "AE", "US", "IN"]} // ✅ Most used countries
      forceCallingCode={forceCallingCode || false} // ✅ Let users change country code
      fullWidth
