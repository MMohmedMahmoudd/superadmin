  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_APP_API_URL}/team/create`,
        data,
        {
          headers: {
      ...
      if (responseData) {
        ...
        if (responseData.data && typeof responseData.data === "object") {
          ...
          Object.entries(fieldErrors).forEach(([field, messages]) => {
            if (Array.isArray(messages) && messages.length > 0) {
              console.log(
                `Setting error for field ${field} in catch:`,
                messages[0]
              );
              enqueueSnackbar(messages[0], { variant: "error" });
              formik.setFieldError(field, messages[0]);
          ...
          <div className="parent-cruds xl:col-span-1  col-span-3 card p-6">
            <div className=" flex justify-center items-center dark:bg-gray-200 bg-gray-100 rounded-lg py-4 flex-col gap-y-4 mb-4">
              ...
              <p className="text-sm text-center text-gray-500 mt-1">
                Only *.png, *.jpg, and *.jpeg person_image files are accepted.
              </p>
            </div>
              ...
              <div className="flex flex-col gap-1 w-full">
                ...
                <label className="input w-full relative">
                  ...
                  >
                    ...
                    ></i>
                    <i
                      className={clsx("ki-filled ki-eye-slash text-gray-500", {
                        hidden: !showPassword,
                      })}
                    ></i>
                  </button>
