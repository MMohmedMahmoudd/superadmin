      ...
      try {
        ...
        do {
          const response = await axios.get(
            `${import.meta.env.VITE_APP_API_URL}/users/list?filter[is_customer]=1&page=${currentPage}`,
            {
              headers: {
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <Select
        ...
        isLoading={loading}
        options={options}
        value={options.find(option => option.value === formik.values.person_uid) || null}
...
export { UsersSelect, customStyles };
