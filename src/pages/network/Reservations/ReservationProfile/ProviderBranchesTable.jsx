...
const ProviderBranchesTable = ({ providerId }) => {
  ...
  const columns = useMemo(() => [
    ...
    },
    {
      ...
      header: 'Status',
      cell: ({ row }) => (
        <span className={`badge badge-${row.original.status === 1 ? 'success' : 'danger'} badge-outline capitalize`}>
          ...
          <div className="bg-white dark:bg-gray-100 w-full max-w-md rounded-lg p-6 shadow-lg relative">
            ...
            <div className="divide-y divide-gray-200 space-y-5 text-base">
              ...
              <div className="pt-2">
                ...
                <div>
                  Lat: {selectedBranch.latitude}<br />
              ...
              <div className="pt-2">
                ...
                <span className={`badge badge-${selectedBranch.status === 1 ? 'success' : 'danger'}`}>
              ...
              <div className="pt-2">
                ...
                <span className={`badge badge-${selectedBranch.main_branch === 1 ? 'primary' : 'info'}`}>
                  {selectedBranch.main_branch === 1 ? 'Main Branch' : 'Sub Branch'}
                </span>
              </div>
            </div>
          </div>
