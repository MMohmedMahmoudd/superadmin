    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        const getStatusBadge = () => {
          switch (statusName) {
            case 'ACTIVE':
              return <span className="badge badge-success badge-outline">● {statusName}</span>;
            case 'COMPLETED':
              return <span className="badge badge-primary badge-outline">● {statusName}</span>;
            case 'CANCELED':
              return <span className="badge badge-danger badge-outline">● {statusName}</span>;
            case 'WAITING PAYMENT':
              return <span className="badge badge-info  badge-outline">● {statusName}</span>;
            case 'WAITING CONFIRMATION':
              return <span className="badge badge-warning badge-outline">● {statusName}</span>;
            case 'WAITING APPROVE FROM CUSTOMER':
              return <span className="badge badge-secondary badge-outline">● {statusName}</span>;
            default:
              return <span className="badge badge-warning badge-outline">● {statusName}</span>;
          }
        };
