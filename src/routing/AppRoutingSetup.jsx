  ...
  return <Routes>
      <Route element={<RequireAuth />}>
        <Route element={<Demo1Layout />}>
          ...
          <Route path="/ProviderProfile/:id" element={
          ...
          <Route path="/editbundle/:id" element={
          ...
          <Route path="/editcurrency/:id" element={
            <ProtectedRoute permissionKey="Edit-Currency" action="edit">
              <EditCurrencyPage />
            </ProtectedRoute>
          } />
          <Route path="/addpaymentmethod" element={
          ...
          <Route path="/maincategories" element={
            <ProtectedRoute permissionKey="Categories" action="list">
              <CategoriesPage />
            </ProtectedRoute>
          } />
          <Route path="/AddBundles" element={
          ...
          <Route path="/RoleProfile/:id" element={
