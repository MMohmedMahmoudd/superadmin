...
const ResetPassword = () => {
  ...
  return <div className="card dark:bg-gray-200 dark:border-gray-200 max-w-[370px] w-full">
      <form className="card-body flex flex-col gap-5 p-10" noValidate onSubmit={formik.handleSubmit}>
        <div className="text-center">
          <h3 className="text-lg font-semibold dark:text-gray-800 text-gray-900">Your Email</h3>
          <span className="text-2sm text-gray-600 dark:text-gray-800 font-medium">
