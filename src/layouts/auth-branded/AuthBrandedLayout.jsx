...
const Layout = () => {
  ...
  return <Fragment>
      <style>
        {`
          .branded-bg {
            background: url('${toAbsoluteUrl('/media/images/2600x1600/BG.png')}') no-repeat center center ;
            background-size: cover;
          }
          .dark .branded-bg {
            background-image: url('${toAbsoluteUrl('/media/images/2600x1600/BG.png')}')no-repeat center center ;
            background-size: cover;
          }
          .
        `}
      ...
      <div className="grid w-full  branded-bg">
